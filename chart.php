...
while ($rowsChart = mysqli_fetch_array($chartWindow, MYSQLI_ASSOC)) {
	...
	$monthWhichHasScoreArray[$mockbidMonth] = $mockbidMonthName;
 	...
 	print_r($monthWhichHasScoreArray);
 	for($x=1;$x<13;$x++){
...
//$result=array_diff($months,$temp);
//print_r($result[1]);

// foreach($result as $key => $value){
	
//  	$mockbidMonthName = $months[$key];
// 	$month_array = array("y" => 0, "label" => "$mockbidMonthName");	
// 	array_push($dataPoints, $month_array);
// }
